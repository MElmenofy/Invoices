                        ...
                        <div class="card mg-b-20">
                            <div class="card-header pb-0">
                                <div class="d-flex justify-content-between">
                                    <div class="col-sm"> <a class="modal-effect btn btn-outline-primary btn-block" data-effect="effect-scale" data-toggle="modal" href="#modaldemo8">اضافة منتج</a>
                                    </div>
                                </div>
                                            ...
                                            @foreach($products as $product)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        @endcan
                                                        @can('حذف منتج')
                                                        <button class="btn btn-outline-danger" data-pro_id="{{ $product->id }}"
