...
@section('page-header')
@section('title')
    الفواتير المؤرشفه - برنامج الفواتير
@stop
				<!-- breadcrumb -->
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">الفواتير</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/الفواتير المؤرشفه</span>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
                                                        ...
                                                        <div class="dropdown-menu tx-13">
                                                            <a class="dropdown-item" href="#" data-invoice_id="{{ $invoice->id }}"
                                                                       data-toggle="modal" data-target="#delete_invoice"><i
                                                                        ...
                                                                        الفاتورة</a>
                                                            <a class="dropdown-item" href="#" data-invoice_id="{{ $invoice->id }}"
                                                               data-toggle="modal" data-target="#Transfer_invoice"><i class="text-warning fas fa-exchange-alt"></i>&nbsp;&nbsp;نقل الي الفواتير</a>
                            ...
                            <div class="modal-content modal-content-demo">
                                ...
                                <div class="modal-body">
                                    <form action="{{route('Archive.update', 'test')}}" method="post">
                                        ...
                                        {{ method_field('patch') }}
                                        <div class="form-group">
                                            هل انت متأكد من عملية اعادة الفاتورة؟
                                        </div>
                                        <div class="form-group">
                                            <input type="hidden" class="form-control" name="invoice_id" id="invoice_id" value="" readonly>
